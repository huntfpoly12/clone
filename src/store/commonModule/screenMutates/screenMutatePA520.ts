const screenMutatePA520 = {
    setCheckEditTab1PA520(state: any, status: boolean) {
        state.checkChangeValueEditTab1PA520 = status
    },
    setCheckEditTab2PA520(state: any, status: boolean) {
        state.checkChangeValueEditTab2PA520 = status
    },
    setCheckChangeValueAddPA520(state: any, status: boolean) {
        state.checkChangeValueAddPA520 = status
    },
    setValidateAddPA520(state: any, status: boolean) {
        state.isValidateAddPA520 = status
    },
    setTab1ValidateEditPA520(state: any, status: boolean) {
        state.isTab1ValidateEditPA520 = status
    },
    ...
    setActionSaveAddPA520(state: any, data: number) {
        state.actionSaveAddPA520 = data
    },
    setActionUpdateTab1PA520(state: any, data: number) {
        state.actionUpdateTab1PA520 = data
    },
