		...
		<div id="pa-730">
			...
			<div class="page-content">
				<DxDataGrid noDataText="내역이 없습니다" id="gridContainerPA730" :show-row-lines="true" :hoverStateEnabled="true"
					...
					<DxColumn caption="원천징수세액계합계" cell-template="sumWithholding" data-field="total" width="150"
						data-type="number" />
					...
					<template #pupop="{ data }">
						<div style="text-align: center">
							...
							<a-tooltip title="출력 / 저장" placement="topLeft">
								<img @click="onPrint(data.data)" src="@/assets/images/print.svg" alt=""
									style="width: 25px" />
							</a-tooltip>
						</div>
					</template>
				...
				<EmailGroupPopup :modalStatus="modalEmailGroup" @closePopup="onCloseEmailGroupModal"
					:data="popupGroupData" />
			</div>
