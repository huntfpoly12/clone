...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const { loading: loadingIncomeBusiness, onError: errorIncomeBusiness, result: resIncomeBusiness } = useQuery(queries.getIncomeBusiness, dataCallApiIncomeBusiness, () => ({
    ...
    watch(() => dataCallApiIncomeBusiness.incomeId, (newVal) => {
      if (+newVal > 0) {
        triggerIncomeBusiness.value = true;
      }
    }, { deep: true })
