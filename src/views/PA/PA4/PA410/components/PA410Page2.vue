<template>
  <div class="page-content">
      ...
      <a-spin :spinning="loading" size="large">
        <div class="select-employee">
          ...
          <div class="input-select">
            <employ-select
              :arrayValue="arrayEmployeeSelect"
              v-model:valueEmploy="valueSelected"
              width="300px"
              :disabled="true"
            />
          </div>
        ...
        <div class="info-employee">
          <standard-form formName="formPA410" ref="formPA410">
              ...
              <a-col :span="12">
                ...
                <div class="input-employee">
                  ...
                  >
                    <date-time-box
                      width="150px"
                      v-model:valueDate="formState.settlementStartDate"
                      ref="payStart"
                    ></date-time-box>
                  </a-form-item>
                  <info-tool-tip placement="right"
                    >퇴직소득 정산의 시작일(기산일)로서, 중간정산지급 등으로
                ...
                <div class="input-employee">
                  ...
                  >
                    <date-time-box-custom
                      width="150px"
                      v-model:valueDate="formState.settlementFinishDate"
                      :startDate="
                  ...
                  <info-tool-tip placement="right"
                    >퇴직소득 정산의 종료일로서, 중간정산지급인 경우 퇴사일과
                ...
                <div class="input-employee">
                  <a-form-item label="제외일수(일)" label-align="right">
                    <div class="d-flex-center">
                      <number-box
                        ...
                        :spinButtons="false"
                        :rtlEnabled="true"
                        v-model:valueInput="formState.exclusionDays"
                        format="0,###"
                      >
                      </number-box>
                    </div>
                  ...
                  <info-tool-tip placement="right"
                    >정산시작(기산)일 기준 제외일수만큼 뒤로 미뤄서 근속일수를
                    계산합니다.</info-tool-tip
                  >
                </div>
                <div class="input-employee">
                  <a-form-item label="가산일수(일)" label-align="right">
                    <div class="d-flex-center">
                      <number-box
                        ...
                        :spinButtons="false"
                        :rtlEnabled="true"
                        v-model:valueInput="formState.additionalDays"
                        format="0,###"
                      >
                      </number-box>
                    </div>
                  ...
                  <info-tool-tip placement="right"
                    >정산시작(기산)일 기준 가산일수만큼 앞으로 당겨서 근속일수를
                    계산합니다.</info-tool-tip
                  >
                </div>
              </a-col>
                  ...
                  <div class="input-salary">
                    ...
                    >
                      <number-box-money
                        ...
                        :spinButtons="false"
                        :rtlEnabled="true"
                        v-model:valueInput="formState.totalPay3Month"
                        :required="true"
                        format="0,###"
                      >
                      </number-box-money>
                  ...
                  <div class="input-salary">
                    ...
                    >
                      <number-box-money
                        ...
                        :spinButtons="false"
                        :rtlEnabled="true"
                        v-model:valueInput="formState.totalAnualBonus"
                        :required="true"
                        format="0,###"
                      >
                      </number-box-money>
                  ...
                  <div class="input-salary">
                    ...
                    >
                      <number-box-money
                        ...
                        :spinButtons="false"
                        :rtlEnabled="true"
                        v-model:valueInput="formState.annualLeaveAllowance"
                        :required="true"
                        format="0,###"
                      >
                      </number-box-money>
            ...
            <div class="time-service">
              <a-tag color="red" style="margin-left: 10px; margin-right: 39px"
                ><span style="color: black; font-size: 14px">근속연월일</span>
              </a-tag>
              <a-tag style="min-width: 150px; text-align: center">
                <span
                  style="color: #c55a11; font-size: 14px; text-align: center"
                >
                  {{
    ...
    <div
      class="infor-text"
      style="text-align: center; margin-bottom: 20px; color: gray"
    >
    ...
    onMounted(() => {
      if (!isEmpty(formStateStep2.value)) {
        ...
        let employeeInfor = store.state.common.arrayEmployeePA410.find(
          (item: any) => item.employeeId == store.state.common.employeeIdPA410
        );
