      ...
      <a-col :span="12">
        ...
        <a-form-item label="퇴직사유" class="label-required">
          <select-box-common :arrSelect="arrayReasonResignation" :required="true"
                             v-model:valueInput="dataGet.specification.retirementReason" placeholder="선택"
                             width="300px"/>
        </a-form-item>
      </a-col>
...
const props = defineProps<{ processKey: any, actionNextStep: number }>()
...
const employee = store.getters['common/getEmployeeEdit'];
