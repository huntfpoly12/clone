                    ...
                    <div v-if="store.state.common.pa510.dataTaxPayInfo.length"
                        ...
                        <div style="margin-left: 70px;">
                            <div class="dx-datagrid-summary-item dx-datagrid-text-content">
                                <div>사원수<span>[{{ store.state.common.pa510.dataTaxPayInfo.length }}]</span></div>
                            </div>
                        </div>
...
import { DxDataGrid, DxColumn, DxSelection, DxSummary, DxTotalItem, DxScrolling, DxMasterDetail, DxPaging } from "devextreme-vue/data-grid"
