<template>
  ...
  <div id="pa-510" class="page-content">
    <a-row
      :class="{
        'ele-opacity':
          (store.state.common.pa510.statusChangeFormEdit &&
            !store.state.common.pa510.statusFormAdd) ||
          (store.state.common.pa510.statusChangeFormAdd &&
            store.state.common.pa510.statusFormAdd),
      }"
    >
      <a-spin :spinning="loading" size="large">
        ...
        >
          ...
          <DxColumn
            :caption="processKey.imputedYear + '귀속월'"
          ...
          <!-- <DxColumn width="100px" caption="01" cell-template="imputed-month1"
                        :cssClass="store.state.common.pa510.processKeyPA510.imputedMonth == 1 ? 'column-focus' : '' + (hoverColClick == 1 ? 'column-hover' : '') + (checkStartYearMonth(1) ? 'disabledBlock' : '') + 'cell-center'" /> -->
          <DxColumn
            width="100px"
            caption="01"
            cell-template="imputed-month1"
            :cssClass="classObject(1)"
          />
          <template #imputed-month1="{ data }">
            <div v-if="data.data.month1">
              <colorful-badge
                class="hover-underlined"
                :value="data.data.month1.status"
                @click="showDetailSelected(data.data.month1)"
                :year="data.data.month1.paymentYear"
                :month="data.data.month1.paymentMonth"
                :isUnder="
                  store.state.common.pa510.processKeyPA510.imputedMonth == 1
                "
              />
            </div>
            <div
          ...
          <DxColumn
            width="100px"
            caption="02"
            cell-template="imputed-month2"
            :cssClass="classObject(2)"
          />
          <template #imputed-month2="{ data }">
            <div v-if="data.data.month2">
              <colorful-badge
                class="hover-underlined"
                :value="data.data.month2.status"
                @click="showDetailSelected(data.data.month2)"
                :year="data.data.month2.paymentYear"
                :month="data.data.month2.paymentMonth"
                :isUnder="
                  store.state.common.pa510.processKeyPA510.imputedMonth == 2
                "
              />
            </div>
            <div
          ...
          <DxColumn
            width="100px"
            caption="03"
            cell-template="imputed-month3"
            :cssClass="classObject(3)"
          />
          <template #imputed-month3="{ data }">
            <div v-if="data.data.month3">
              <colorful-badge
                class="hover-underlined"
                :value="data.data.month3.status"
                @click="showDetailSelected(data.data.month3)"
                :year="data.data.month3.paymentYear"
                :month="data.data.month3.paymentMonth"
                :isUnder="
                  store.state.common.pa510.processKeyPA510.imputedMonth == 3
                "
              />
            </div>
            <div
          ...
          <DxColumn
            width="100px"
            caption="04"
            cell-template="imputed-month4"
            :cssClass="classObject(4)"
          />
          <template #imputed-month4="{ data }">
            <div v-if="data.data.month4">
              <colorful-badge
                class="hover-underlined"
                :value="data.data.month4.status"
                @click="showDetailSelected(data.data.month4)"
                :year="data.data.month4.paymentYear"
                :month="data.data.month4.paymentMonth"
                :isUnder="
                  store.state.common.pa510.processKeyPA510.imputedMonth == 4
                "
              />
            </div>
            <div
          ...
          <DxColumn
            width="100px"
            caption="05"
            cell-template="imputed-month5"
            :cssClass="classObject(5)"
          />
          <template #imputed-month5="{ data }">
            <div v-if="data.data.month5">
              <colorful-badge
                class="hover-underlined"
                :value="data.data.month5.status"
                @click="showDetailSelected(data.data.month5)"
                :year="data.data.month5.paymentYear"
                :month="data.data.month5.paymentMonth"
                :isUnder="
                  store.state.common.pa510.processKeyPA510.imputedMonth == 5
                "
              />
            </div>
            <div
          ...
          <DxColumn
            width="100px"
            caption="06"
            cell-template="imputed-month6"
            :cssClass="classObject(6)"
          />
          <template #imputed-month6="{ data }">
            <div v-if="data.data.month6">
              <colorful-badge
                class="hover-underlined"
                :value="data.data.month6.status"
                @click="showDetailSelected(data.data.month6)"
                :year="data.data.month6.paymentYear"
                :month="data.data.month6.paymentMonth"
                :isUnder="
                  store.state.common.pa510.processKeyPA510.imputedMonth == 6
                "
              />
            </div>
            <div
          ...
          <DxColumn
            width="100px"
            caption="07"
            cell-template="imputed-month7"
            :cssClass="classObject(7)"
          />
          <template #imputed-month7="{ data }">
            <div v-if="data.data.month7">
              <colorful-badge
                class="hover-underlined"
                :value="data.data.month7.status"
                @click="showDetailSelected(data.data.month7)"
                :year="data.data.month7.paymentYear"
                :month="data.data.month7.paymentMonth"
                :isUnder="
                  store.state.common.pa510.processKeyPA510.imputedMonth == 7
                "
              />
            </div>
            <div
          ...
          <DxColumn
            width="100px"
            caption="08"
            cell-template="imputed-month8"
            :cssClass="classObject(8)"
          />
          <template #imputed-month8="{ data }">
            <div v-if="data.data.month8">
              <colorful-badge
                class="hover-underlined"
                :value="data.data.month8.status"
                @click="showDetailSelected(data.data.month8)"
                :year="data.data.month8.paymentYear"
                :month="data.data.month8.paymentMonth"
                :isUnder="
                  store.state.common.pa510.processKeyPA510.imputedMonth == 8
                "
              />
            </div>
            <div
          ...
          <DxColumn
            width="100px"
            caption="09"
            cell-template="imputed-month9"
            :cssClass="classObject(9)"
          />
          <template #imputed-month9="{ data }">
            <div v-if="data.data.month9">
              <colorful-badge
                class="hover-underlined"
                :value="data.data.month9.status"
                @click="showDetailSelected(data.data.month9)"
                :year="data.data.month9.paymentYear"
                :month="data.data.month9.paymentMonth"
                :isUnder="
                  store.state.common.pa510.processKeyPA510.imputedMonth == 9
                "
              />
            </div>
            <div
          ...
          <template #row-detail="{}">
            ...
            >
              ...
              <DxColumn
                width="100px"
                cell-template="month-1"
                :cssClass="classObjectDetail(1)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-2"
                :cssClass="classObjectDetail(2)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-3"
                :cssClass="classObjectDetail(3)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-4"
                :cssClass="classObjectDetail(4)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-5"
                :cssClass="classObjectDetail(5)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-6"
                :cssClass="classObjectDetail(6)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-7"
                :cssClass="classObjectDetail(7)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-8"
                :cssClass="classObjectDetail(8)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-9"
                :cssClass="classObjectDetail(9)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-10"
                :cssClass="classObjectDetail(10)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-11"
                :cssClass="classObjectDetail(11)"
              />
              ...
              <DxColumn
                width="100px"
                cell-template="month-12"
                :cssClass="classObjectDetail(12)"
              />
      ...
      <a-col>
        <div v-if="!statusDisabledBlock">
          <DxButton
            :text="
              '귀 ' +
              processKey.imputedYear +
              '-' +
              $filters.formatMonth(processKey.imputedMonth)
            "
    ...
    <a-row :class="{ disabledBlock: statusDisabledBlock }">
      ...
      >
        <a-spin :spinning="loadingTaxPayInfo" size="large">
          <DxDataGrid
            noDataText="내역이 없습니다"
            id="data-tax-pay-info"
            :show-row-lines="true"
            :hoverStateEnabled="true"
            :data-source="store.state.common.pa510.dataTaxPayInfo"
            :show-borders="true"
            :allow-column-reordering="move_column"
            ...
            <template #four-major-insurance="{ data }">
              <div class="custom-action custom-grade-cell">
                ...
                <four-major-insurance
                  ...
                  :typeTag="7"
                  :ratio="
                    data.data.employee.employeementInsuranceSupportPercent
                  "
                />
                <four-major-insurance
      ...
      <a-col
        :span="10"
        class="custom-layout custom-form-data"
    ...
    <PopupMessage
      :modalStatus="modalChangeRow"
      @closePopup="modalChangeRow = false"
      typeModal="confirm"
...
export default defineComponent({
  ...
  setup() {
    ...
    watch(result, (value) => {
      ...
      const obj =
        dataSource.value[0][
          "month" + store.state.common.pa510.processKeyPA510.imputedMonth
        ];
      if (obj) {
        // nếu có data source
      ...
      (newVal) => {
        if (newVal.id == "pa-510") {
          ...
          if (
            ...
            IncomeWageDailiesTrigger.value = true; //reset data table 2
            !store.state.common.pa510.statusRowAdd
    ...
    const selectionChanged = (data: any) => {
      ...
      if (
        data.selectedRowsData.find(
          (element: any) => element.incomeId == "PA510" ?? null
        )
      ) {
        gridRefPA510.value?.instance.deselectAll();
        dataRows.value = [];
    ...
    const showDetailSelected = (month: any) => {
      if (
        ...
        store.state.common.pa510.processKeyPA510.paymentMonth !=
          month.paymentMonth ||
        store.state.common.pa510.processKeyPA510.imputedMonth !=
          month.imputedMonth
      ) {
    ...
    const classObject = (month: number) => {
      ...
      store.state.common.pa510.processKeyPA510.imputedMonth == month
        ? (string += " column-focus")
        : "";
