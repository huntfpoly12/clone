    ...
    <standard-form action="" name="add-page-210" style="border: 1px solid #d7d7d7; padding: 10px;">
        <a-row>
            ...
            <a-col :span="12">
                ...
                <a-form-item label="근무일수">
                    <text-number-box :disabled="true" v-model:valueInput="dataIncomeWageDaily.workingDays" width="200px"
                        :required="true" />
                </a-form-item>
                <a-form-item label="월급여">
                    <text-number-box :disabled="true" v-model:valueInput="dataIncomeWageDaily.monthlyWage" width="200px"
                        :required="true" />
                </a-form-item>
