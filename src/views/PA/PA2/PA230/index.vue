<template>
            ...
            <a-row :gutter="[24, 8]">
              <a-col>
                <div class="d-flex-center">
                  ...
                  <radio-group :arrayValue="radioCheckDataSearch" v-model:valueRadioCheck="checkBoxOption"
                    layoutCustom="horizontal" class="mt-7" />
                </div>
              </a-col>
              <a-col>
        ...
        <DxDataGrid ref="dataGrid" :show-row-lines="true" :hoverStateEnabled="true" :data-source="dataSource"
          ...
          <template #employee-info="{ data }">
            <employee-info :idEmployee="data.data.employeeId" :name="data.data.employee.name"
              ...
              :foreigner="data.data.employee.foreigner" :checkStatus="false" :employeeId="data.data.employeeId" />
          </template>
  ...
  <a-modal v-if="modalSendMail" :visible="modalSendMail" @cancel="modalSendMail = false" width="562px" footer=""
    :mask-closable="false">
    <standard-form>
      ...
      <a-row style="margin-top: 50px;">
        <a-col :span="16" :offset="6">
          ...
          <button-basic text="네. 발송합니다" type="default" mode="contained" :width="150" @onClick="confirmSendMail" />
        </a-col>
      </a-row>
    </standard-form>
  </a-modal>
...
import { DxColumn, DxDataGrid, DxItem, DxScrolling, DxSelection, DxSummary, DxToolbar, DxTotalItem } from "devextreme-vue/data-grid";
