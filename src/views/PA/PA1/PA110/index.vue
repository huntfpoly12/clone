  ...
  <div>
    ...
    <div id="pa-110" class="page-content">
            ...
            <template #imputed-month1="{ data }">
              <div v-if="data.data.month1">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 1
                  "
            ...
            <template #imputed-month2="{ data }">
              <div v-if="data.data.month2">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 2
                  "
            ...
            <template #imputed-month3="{ data }">
              <div v-if="data.data.month3">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 3
                  "
            ...
            <template #imputed-month4="{ data }">
              <div v-if="data.data.month4">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 4
                  "
            ...
            <template #imputed-month5="{ data }">
              <div v-if="data.data.month5">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 5
                  "
            ...
            <template #imputed-month6="{ data }">
              <div v-if="data.data.month6">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 6
                  "
            ...
            <template #imputed-month7="{ data }">
              <div v-if="data.data.month7">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 7
                  "
            ...
            <template #imputed-month8="{ data }">
              <div v-if="data.data.month8">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 8
                  "
            ...
            <template #imputed-month9="{ data }">
              <div v-if="data.data.month9">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 9
                  "
            ...
            <template #imputed-month10="{ data }">
              <div v-if="data.data.month10">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 10
                  "
            ...
            <template #imputed-month11="{ data }">
              <div v-if="data.data.month11">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 11
                  "
            ...
            <template #imputed-month12="{ data }">
              <div v-if="data.data.month12">
                <colorful-badge
                  ...
                  :isUnder="
                    store.state.common.pa110.processKeyPA110.imputedMonth == 12
                  "
      ...
      <a-row
        ...
        style="border: 1px solid #d7d7d7; padding: 10px; margin-top: 10px"
      ...
      <a-row :class="{ disabledBlock: statusDisabledBlock }">
        <a-col
          :span="12"
          class="custom-layout custom-layout-table"
          :class="{
            'ele-opacity':
              (store.state.common.pa110.statusChangeFormEdit &&
                !store.state.common.pa110.statusFormAdd) ||
        ...
        >
          <a-spin :spinning="loadingTaxPayInfo" size="large">
            <DxDataGrid
              ...
              :show-row-lines="true"
              :hoverStateEnabled="true"
              :data-source="store.state.common.pa110.dataTaxPayInfo"
              :show-borders="true"
              :allow-column-reordering="move_column"
