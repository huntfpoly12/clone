<template>
  <div id="pa-110">
    <a-spin
      :key="countKey"
      :spinning="loading || loadingGetEmployeeWage"
      size="large"
    >
      <StandardForm formName="pa-110-form" ref="pa110FormRef">
        <a-row class="row-1">
          <a-col :span="12">
            <a-form-item
              label="사원"
              :class="store.state.common.pa110.statusFormAdd ? 'red' : ''"
            >
              <EmploySelect
                ...
                "
                :required="true"
                v-model:valueEmploy="dataIW.employee.employeeId"
                width="316px"
          ...
          <a-col :span="12">
            <a-form-item label="지급일" class="red">
              <date-time-box-custom
                ref="requiredPaymentDay"
                width="150px"
                :required="true"
                :startDate="startDate"
                :finishDate="finishDate"
                v-model:valueDate="dataIW.paymentDay"
                :disabled="
                  !store.state.common.pa110.statusFormAdd ||
                  store.state.common.pa110.statusDisabledStatus
                "
            ...
            <div class="summary">
              <div class="d-flex-center">
                ...
                <number-box-money
                  :disabled="true"
                  width="100px"
                  v-model:valueInput="totalPayItem"
                />
                <span class="pl-5">원</span>
                <a-tooltip color="black" placement="top">
                  <template #title
                    >수당 합계 = 수당 과세 + 수당 비과세</template
                  >
              ...
              <div class="text1 d-flex-center">
                ...
                <number-box-money
                  :disabled="true"
                  width="100px"
                  v-model:valueInput="totalPayItemTaxFree"
                />
                <span class="pl-5">원</span>
              </div>
              ...
              <div class="d-flex-center">
                ...
                <number-box-money
                  :disabled="true"
                  width="100px"
                  v-model:valueInput="totalDeduction"
                />
                <span class="pl-5">원</span>
              </div>
              <div class="d-flex-center">
            ...
            <a-form-item label="근무일수" label-align="right">
              <div style="display: flex; align-items: center">
                <number-box
                  ...
                  :max="31"
                  width="100px"
                  v-model:valueInput="dataIW.workingDays"
                  :required="true"
                />
            ...
            <a-form-item label="총근로시간" label-align="right">
              <div style="display: flex; align-items: center">
                <number-box
                  ...
                  :min="0"
                  width="100px"
                  v-model:valueInput="dataIW.totalWorkingHours"
                  :required="true"
                />
            ...
            <a-form-item label="연장근로시간" label-align="right">
              <div style="display: flex; align-items: center">
                <number-box
                  ...
                  :min="0"
                  width="100px"
                  v-model:valueInput="dataIW.overtimeWorkingHours"
                  :required="true"
                />
                <span style="padding-left: 5px">시간</span>
              </div>
            ...
            <a-form-item label="야간근로시간" label-align="right">
              <div style="display: flex; align-items: center">
                <number-box
                  ...
                  :min="0"
                  width="100px"
                  v-model:valueInput="dataIW.workingHoursAtNight"
                  :required="true"
                />
                <span style="padding-left: 5px">시간</span>
              </div>
            ...
            <a-form-item label="휴일근로시간" label-align="right">
              <div style="display: flex; align-items: center">
                <number-box
                  ...
                  :min="0"
                  width="100px"
                  v-model:valueInput="dataIW.workingHoursOnHolidays"
                  :required="true"
                />
                <span style="padding-left: 5px">시간</span>
              </div>
        ...
        <a-row :gutter="16">
          <a-col :span="13">
            ...
            <a-spin :spinning="loadingConfigPayItems" size="large">
              <div class="deduction-main">
                <div
                  v-for="item in dataConfigPayItems"
                  :key="item.name"
                ...
                >
                  ...
                  <div>
                    <number-box-money
                      :disabled="store.state.common.pa110.statusDisabledStatus"
                      width="130px"
                      @changeInput="onChangeInputPayItem"
                      :spinButtons="false"
                      :rtlEnabled="false"
                      v-model:valueInput="item.amount"
                      :min="0"
                    >
                    </number-box-money>
                    <span class="pl-5">원</span>
          ...
          <a-col :span="11">
            ...
            <a-spin :spinning="loadingConfigDeductions" size="large">
              <div class="deduction-main">
                <div
                  v-for="(item, index) in dataConfigDeductions"
                  :key="index"
                  class="custom-deduction"
                >
                  <span>
                  ...
                  <div>
                    <a-tooltip
                      color="black"
                      :class="
                        item.itemCode == 1012 && localIncomeBoo ? 'red' : ''
                      "
                      placement="top"
                      zIndex="9999"
                      :title="
                        item.itemCode == 1012 && localIncomeBoo
                    ...
                    >
                      ...
                      <span>
                        <number-box-money
                          ...
                          :rtlEnabled="true"
                          v-model:valueInput="item.amount"
                          @changeInput="onChangeInputDeduction"
                          :disabled="
                            store.state.common.pa110.statusDisabledStatus
                          "
                          format="#0,###"
          ...
          <a-col :offset="4" style="text-align: center">
            ...
            >
              <a-tooltip placement="top" :overlayStyle="{ maxWidth: '500px' }">
                <template #title
                  >입력된 급여 금액으로 공제 재계산합니다.</template
                >
                <div>
                  <button-tooltip-error
                    :disabled="store.state.common.pa110.statusDisabledStatus"
                    :statusChange="
                      store.state.common.pa110.statusChangeFormPrice
                    "
              ...
              <a-tooltip placement="top">
                ...
                <div>
                  <button-basic
                    ...
                    "
                    style="margin: 0px 5px"
                    @onClick="modalDeteleTaxpay = true"
                    mode="contained"
                    type="default"
                    text="중도정산 반영"
                  />
    ...
    <DeductionPopup
      :modalStatus="modalDeductions"
      @closePopup="modalDeductions = false"
      :data="dataConfigDeductions"
      @updateDate="updateDataDeduction"
    />
    <InsurancePopup
      :modalStatus="modalInsurance"
      @closePopup="modalInsurance = false"
    />
    <DeletePopupTaxPay
      :modalStatus="modalDeteleTaxpay"
      @closePopup="modalDeteleTaxpay = false"
    />
    <DeletePopupMidTerm
      :modalStatus="modalDeteleMidTerm"
      @closePopup="modalDeteleMidTerm = false"
      :data="dataIW"
    />
  </div>
</template>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const {
      ...
      onResult: resConfigPayItems,
      loading: loadingConfigPayItems,
    } = useQuery(
        ...
        value.map((item: any) => {
          if (item.itemCode == 1012) {
            item.amount =
              value.find((item: any) => item.itemCode == 1012).amount < 1000
                ? 0
                : value.find((item: any) => item.itemCode == 1012).amount;
          }
        });
        calculateTax();
      },
    ...
    watch(result, async (value) => {
      ...
      if (data) {
        ...
        if (data.midTermSettlement != null) {
          statusMidTermSettlement1.value = data.midTermSettlement
            ? false
            : true;
          statusMidTermSettlement2.value = data.midTermSettlement
            ? true
            : false;
        } else {
      ...
      if (!res.isValid) {
        ...
        if (store.state.common.pa110.statusFormAdd) {
          (variables.input.employeeId = dataIW.value.employee.employeeId),
            (variables.input.paymentDay =
              parseInt(dataIW.value.paymentDay?.toString().slice(6, 8)) ?? 1),
    ...
    const calculateTax = async () => {
      await (totalPayItem.value = dataConfigPayItems.value?.reduce(
        (accumulator: any, object: any) => {
          return accumulator + object.amount;
        },
        0
      ));
      await (totalPayItemTax.value = dataConfigPayItems.value?.reduce(
        (accumulator: any, object: any) => {
      ...
      await (totalPayItemTaxFree.value = dataConfigPayItems.value?.reduce(
        (accumulator: any, object: any) => {
          if (!object.taxfreePayItemCode) {
            accumulator += object.amount;
          }
      ...
      await (totalDeduction.value = dataConfigDeductions.value?.reduce(
        (accumulator: any, object: any) => {
          return accumulator + object.amount;
        },
        0
