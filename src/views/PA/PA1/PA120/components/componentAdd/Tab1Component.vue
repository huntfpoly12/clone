  ...
  <div id="tab1-pa120">
    <a-spin :spinning="loading" size="large">
        ...
        <a-col>
          <a-form-item label="영업자코드" label-align="right">
            <div class="input-text">
              <switch-basic
                v-model:valueSwitch="formStateTab1.president"
                textCheck="O"
                textUnCheck="X"
                style="width: 80px"
              ></switch-basic>
      ...
      <a-form-item label="성명" label-align="right" class="red">
        <text-number-box
          width="200px"
          v-model:valueInput="formStateTab1.name"
          :required="true"
      ...
      <a-form-item label="입사년월일" label-align="right">
        <date-time-box
          width="150px"
          v-model:valueDate="formStateTab1.joinedAt"
      ...
      <a-form-item label="퇴사년월일" label-align="right">
        <div class="input-text">
          <date-time-box
            width="150px"
            v-model:valueDate="formStateTab1.leavedAt"
            dateFormat="YYYY-MM-DD"
          ></date-time-box>
          <span> <InfoCircleFilled /> 마지막 근무한 날 </span>
        </div>
      </a-form-item>
      <a-row>
        <a-col :span="7">
        ...
        <a-col :span="9">
          <a-form-item label="외국인 국적" label-align="right" class="red">
            <country-code-select-box
              v-model:valueCountry="formStateTab1.nationalityCode"
        ...
        <a-col :span="8">
          <a-form-item label="외국인 체류자격" label-align="right" class="red">
            <stay-qualification-select-box
              v-model:valueStayQualifiction="formStateTab1.stayQualification"
            />
          </a-form-item>
        </a-col>
      </a-row>
        ...
        <a-row :gutter="[0, 4]">
          ...
          <a-col :span="24">
            <a-row>
              <a-col :span="12">
                <default-text-box
                  v-model:valueInput="formStateTab1.roadAddress"
                  width="100%"
                  :disabled="true"
                  placeholder="주소1"
                />
              ...
              <a-col :span="12" style="padding-left: 9px">
                <default-text-box
                  v-model:valueInput="formStateTab1.addressExtend"
                  width="100%"
                  placeholder="주소2"
                />
              </a-col>
      ...
      <a-form-item label="이메일" label-align="right">
        <div class="input-text">
          <mail-text-box
            v-model:valueInput="formStateTab1.email"
            width="200px"
      ...
      <a-form-item label="부서" label-align="right">
        <custom-item-select-box
          width="200px"
          v-model:valueInput="formStateTab1.department"
          :arrSelect="arrDepartments"
        ></custom-item-select-box>
      </a-form-item>
      <a-form-item label="직위" label-align="right">
        <custom-item-select-box
          width="200px"
          v-model:valueInput="formStateTab1.responsibility"
          :arrSelect="arrResponsibility"
        ></custom-item-select-box>
      </a-form-item>
