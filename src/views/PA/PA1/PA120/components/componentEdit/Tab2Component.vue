            ...
            <a-row :gutter="16">
                <a-col span="24" style="display: flex">
                    ...
                    <div class="input-text empl-ins">
                        <checkbox-basic size="18px" label="고용보험"
                            v-model:valueCheckbox="formStateTab2.employeementInsuranceDeduction"></checkbox-basic>
                        <span>
                    ...
                    <a-row :gutter="[0, 10]">
                        ...
                        <a-col span="12">
                            <radio-group :arrayValue="radioCheckPersenPension"
                                ...
                                :disabled="!formStateTab2.longTermCareInsuranceDeduction"></radio-group>
                        </a-col>
                ...
                <a-col :span="12">
                    ...
                    <a-row :gutter="[0, 10]">
                        ...
                        <a-col span="12">
                            <switch-basic switch-basic textCheck="Y" textUnCheck="N" class="switch-insurance"
                                v-model:valueSwitch="formStateTab2.employeementReduction"
                                @onChange="onChangeSwitch2"></switch-basic>
                        </a-col>
                    ...
                    <a-row>
                        ...
                        <a-col span="19" class="income-tax-app-rate">
                            <radio-group :arrayValue="IncomeTaxAppRate"
                                v-model:valueRadioCheck="formStateTab2.incomeTaxMagnification"
            ...
            <a-row :gutter="16">
                <a-col :span="8">
                    ...
                    <div class="summary">
                        ...
                        <div class="text2">수당 비과세 합계 <span>{{ $filters.formatCurrency(totalPayItemTaxFree) }}</span>원
                        </div>
