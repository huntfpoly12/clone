        ...
        <a-spin :spinning="loading" size="large">
            <standard-form formName="tab1-pa120">
                    ...
                    <a-col>
                        <a-form-item label="영업자코드" label-align="right">
                            <div class="input-text">
                                <switch-basic v-model:valueSwitch="formStateTab1.president" textCheck="O"
                                    textUnCheck="X" style="width: 80px"></switch-basic>
                                <span>
                ...
                <a-row>
                    ...
                    <a-col :span="9">
                        <a-form-item label="외국인 국적" label-align="right" class="red">
                            <country-code-select-box v-model:valueCountry="formStateTab1.nationalityCode"
                ...
                <a-form-item :label="labelResidebId" label-align="right" class="red">
                    <id-number-text-box :required="true" v-model:valueInput="residentId" width="150px">
                    </id-number-text-box>
                </a-form-item>
                <a-form-item label="주소" class="clr" label-align="left">
                    <a-row :gutter="[0, 4]">
                        ...
                        <a-col :span="24">
                            <a-row>
                                <a-col :span="12">
                                    <default-text-box v-model:valueInput="formStateTab1.roadAddress" width="100%"
                                        :disabled="true" placeholder="주소1" />
                                </a-col>
                                <a-col :span="12" style="padding-left: 9px">
                                    <default-text-box v-model:valueInput="formStateTab1.addressExtend" width="100%"
                                        placeholder="주소2" />
                                </a-col>
                            </a-row>
                        </a-col>
