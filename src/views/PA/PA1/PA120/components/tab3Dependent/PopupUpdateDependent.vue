              ...
              <!-- {{ itemSelected }} itemSelected <br /> -->
                    ...
                    <a-row>
                        <a-col :span="12">
                            ...
                            <a-form-item label="성명" label-align="right" class="red">
                                <default-text-box placeholder="한글,영문(대문자) 입력 가능" width="200px" :required="true" :disabled="disabledButton || formState.relation == 0"
                            ...
                            <a-form-item label="내/외국인" label-align="right" class="switchForeigner">
                                <switch-basic textCheck="외국인" textUnCheck="내국인"
                                    v-model:valueSwitch="formState.foreigner" :disabled="disabledButton || formState.relation == 0"/>
                            </a-form-item>
                            ...
                            <a-form-item label="나이" label-align="right">
                                <default-text-box width="200px" :disabled="true || formState.relation == 0" v-model:valueInput="ageCount">
                                </default-text-box>
                            </a-form-item>
                            <a-form-item label="기본공제" label-align="right" class="red">
                                <basic-deduction-select-box width="200px" v-model:valueInput="formState.basicDeduction"
                                    :required="true" :disabled="disabledButton || formState.relation == 0" :ageCount="ageCount"/>
                            </a-form-item>
                            <a-form-item label="부녀자" label-align="right">
                                <switch-basic textCheck="O" textUnCheck="X" v-model:valueSwitch="formState.women"  :disabled="formState.relation == 0"/>
                            </a-form-item>
                            <a-form-item label="한부모" label-align="right">
                              <div class="input-text">
                                <switch-basic textCheck="O" textUnCheck="X" v-model:valueSwitch="formState.singleParent" :disabled="formState.relation == 0" />
                        ...
                        <a-col :span="12">
                            <a-form-item label="경로우대" label-align="right">
                              <div class="input-text">
                                <switch-basic textCheck="O" textUnCheck="X" v-model:valueSwitch="formState.senior" :disabled="isDisabledSenior || formState.relation == 0"/>
                                <span style="color: #888888; font-size:11px">
                            ...
                            <a-form-item label="장애인" label-align="right">
                                <disabled-type-radio-group v-model:valueRadioCheck="formState.disabled" :disabled="formState.relation == 0">
                                </disabled-type-radio-group>
                            </a-form-item>
                            <a-form-item label="출산입양" label-align="right">
                                <maternity-adoption-radio-box v-model:valueRadioCheck="formState.maternityAdoption" :disabled="formState.relation == 0">
                                </maternity-adoption-radio-box>
                            </a-form-item>
                            <a-form-item label="자녀세액공제" label-align="right" class="d-flex-nowrap">
                              <div class="input-text long-text">
                                <switch-basic textCheck="O" textUnCheck="X" v-model:valueSwitch="formState.descendant" :disabled="formState.relation == 0" />
                                <span style="color: #888888; font-size:11px">
                            ...
                            <a-form-item label="위탁관계" label-align="right">
                                <default-text-box placeholder="최대 20자" width="200px" :maxCharacter="20" :disabled="consignDisabled || formState.relation == 0"
                ...
                <a-row style="margin-top: 40px" justify="center">
                  ...
                  <button-basic text="저장" type="default" mode="contained" :width="90"
                      @onClick="actionUpdated($event)" :disabled="disabledButton || formState.relation == 0" />
                </a-row>
