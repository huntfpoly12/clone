  ...
  <div id="pa-810" class="px-10 py-10">
    <a-spin :spinning="loading" size="large">
      <DxDataGrid :show-row-lines="true" :hoverStateEnabled="true" :data-source="dataSource" :show-borders="true"
        ...
        :column-auto-width="true" noDataText="내역이 없습니다" style="max-height: 770px">
        ...
        <DxColumn caption="첨부파일다운로드" data-field="dependentsEvidenceFileStorageId"
          cell-template="dependentsEvidenceFileStorageId" width="80" alignment="center" />
    ...
    <div v-if="isOpenModalCreate">
      <CreatePA810Popup :isOpenModalCreate="isOpenModalCreate" @closeModal="isOpenModalCreate = false"
        @handleCreate="handleCreate" :manageId=manageId />
    </div>
  </div>
</template>
...
const {
  onResult: getMajorInsuranceResult,
