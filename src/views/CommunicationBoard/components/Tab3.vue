  ...
  <a-row :gutter="12">
    <a-col :span="14">
      ...
      >
        ...
        <DxColumn caption="삭제 여부" data-field="delete" alignment="end" cell-template="delete"/>
        <DxColumn caption="구분" data-field="division" alignment="end" cell-template="division"/>
