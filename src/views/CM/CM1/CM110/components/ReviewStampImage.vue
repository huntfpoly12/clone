            ...
            <div class="stamp-image-content">
                <div class="stamp-child">
                    <div class="stamp-text-note">
                        ...
                        <div>
                            <a-typography-text>
                                직인에 인쇄될 상호를 입력하신 후 <br />미리보기 버튼을 누르세요.
                            </a-typography-text>
                        </div>
                    </div>
                </div>
                <div class="stamp-child">
                        <default-text-box  v-model:valueInput="signature"
                            ...
                            placeholder="2~15자 (특수문자불가)" :maxlength="15"></default-text-box>

                        <button-basic :disabled="disabledBtnPreview" @onClick="createMyCompanyAutoGeneratedSeal"
                ...
                <div class="stamp-child">
                    <button-basic class="btn-stamp" @onClick="handOk" :text="'사용하기'" :type="'default'"
                        :mode="'contained'" />
                </div>
            </div>
