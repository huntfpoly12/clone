                        ...
                        <div style="display: flex;">
                            <div>
                                <a-form-item label="사업자유형">
                                    <a-input v-model:value="formState.bizType" :disabled="true" style="width: 120px" />
                                </a-form-item>
                            </div>
                        ...
                        <div style="display: flex;">
                            <a-form-item label="이메일">
                                <a-input v-model:value="formState.extendInfo.president.email" style="width: 300px"
                                    @change="validateEmail" :style="!statusMailValidate ? { borderColor: 'red'}: ''" />
                            </a-form-item>
...
export default defineComponent({
    ...
    setup() {
        ...
        const formState = ref({
            name: "효사랑노인요양전문병원",
            bizType: "고객",
            bizNumber: "215-87-15485",
            address: "효사랑노인요양전문병원",
            presidentMobilePhone: "0428753658",
            fax: "0428743651",
            직인인감:
            ...
            extendInfo: {
                president: {
                    name: "홍길동",
                    birthday: "28012000",
                    mobilePhone: "19801231",
                    email: "bankda.jangbuda@gmail.com",
                },
                detail: {
                    name: "",
                    zipcode: "",
        ...
        const onSubmit = () => {
            ...
            console.log(formState.value.extendInfo.president.email);
