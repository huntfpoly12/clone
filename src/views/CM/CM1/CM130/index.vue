            ...
            <a-tab-pane key="2" tab="급여항목">
                <div class="page-content">
                    <DxDataGrid :data-source="dataSource" :show-borders="true" key-expr="ID" @exporting="onExporting">
                        ...
                        <DxColumn data-field="이용여부" :width="80" cell-template="use" css-class="cell-center" />
                        <template #use="{ data }">
                        ...
                        <DxColumn data-field="비과세코드" css-class="cell-center" :width="100" />
                        <DxColumn data-field="제출여부" :width="80" css-class="cell-center" />
                ...
                <AddCM130Popup :modalStatus="modalAddNewStatus" @closePopup="modalAddNewStatus = false"
                    title="원천설정 [ cm-130 –pop ]" />
                <EditCM130Popup :modalStatus="modalEditStatus" @closePopup="modalEditStatus = false" :data="popupData"
                    title="원천설정 [ cm-130 –pop] " />
                <HistoryPopup :modalStatus="modalHistoryStatus" @closePopup="modalHistoryStatus = false"
                    :data="popupData" title="변경이력[cm-130-pop]" />
            </a-tab-pane>
        </a-tabs>
    </div>
</template>
