                    ...
                    <a-col :span="6">
                      <a-form-item label="일괄납부 여부" :label-col="labelCol">
                        <switch-basic
                          style="width: 80px"
                          :disabled="true"
                          v-model:valueSwitch="formState.collectivePayment"
                          :textCheck="'적용'"
                          :textUnCheck="'미적용'"
                        />
                      </a-form-item>
                    ...
                    <a-col :span="12">
                      ...
                      >
                        <switch-basic
                          style="width: 80px"
                          :disabled="true"
                          v-model:valueSwitch="formState.taxForEachBusiness"
                          :textCheck="'적용'"
                          :textUnCheck="'미적용'"
                        />
                      </a-form-item>
                  ...
                  <a-row :gutter="24">
                    <a-col>
                      <a-form-item label="사업장주소" :label-col="labelCol">
                        <default-text-box
                          style="width: 565px; margin-right: 10px; float: left"
                          :disabled="true"
                          v-model:valueInput="
      ...
      <a-tab-pane key="3" tab="공제항목">
        <a-spin tip="Loading..." :spinning="loadingDeduction">
          <DxDataGrid
            ...
            :data-source="dataSourceDeduction"
            :show-borders="true"
            key-expr="itemCode"
            ...
            v-model:focused-row-key="focusedRowKeyTab3"
            ref="gridRefCM110Tab3"
            @focused-row-changing="onFocusedRowChangingTab3"
        ...
        <standard-form
          formName="add-deduction-310"
          v-if="dataSourceDeduction.length"
          class="standard-form"
        >
          ...
          <a-row :gutter="24">
            <a-col :span="5">
              <a-form-item label="코드" :label-col="labelCol">
                <number-box
                  :width="150"
                  :min="0"
                  v-model:valueInput="formStateDeduction.itemCode"
                  :spinButtons="true"
                  :disabled="true"
                >
                </number-box>
            ...
            <a-col :span="6">
              <switch-basic
                style="width: 80px"
                v-model:valueSwitch="formStateDeduction.use"
                :textCheck="'이용중'"
                :textUnCheck="'이용중지'"
                :disabled="true"
              />
            ...
            <a-col :span="14">
              <a-form-item label="항목명" :label-col="labelCol">
                <default-text-box
                  ...
                  v-model:valueInput="formStateDeduction.name"
                  :disabled="true"
                >
                </default-text-box>
              </a-form-item>
        ...
        <HistoryPopup
          :modalStatus="modalHistoryStatusDeduction"
          @closePopup="modalHistoryStatusDeduction = false"
          title="변경이력"
          typeHistory="cm-deduction-130"
        />
      </a-tab-pane>
    </a-tabs>
    <PopupMessage
...
export default defineComponent({
  ...
  setup() {
    ...
    const {
      ...
      refetch: refetchConfigInstitution,
