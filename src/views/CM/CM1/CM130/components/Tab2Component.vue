<template>
  <a-spin tip="Loading..." :spinning="loadingWithholdingConfig">
    <DxDataGrid
      ...
      v-model:focused-row-key="focusedRowKeyTab2"
      :focused-row-enabled="true"
      ref="gridRefCM110Tab2"
      @focused-row-changing="onFocusedRowChangingTab2"
    ...
    >
      ...
      <template #pupop="{ data }">
        <div class="custom-action">
          <deleteOutlined
            v-if="data.data.useChangable"
            @click="statusAddRow ? deleteConfig(data) : ''"
          />
        </div>
      </template>
    </DxDataGrid>
          ...
          <a-row>
            <a-col :span="24">
              <div style="display: -webkit-inline-box">
                ...
                <a-tooltip color="black" placement="top">
                  <template #title
                    >비과세인 경우 동일한 유형은 중복등록 불가합니다.</template
                  >
