    ...
    <div class="page-content">
      <a-spin :spinning="loadingTable" size="large">
        ...
        <div style="border: 1px solid #ddd; border-top: none; width: 100%; display: flex; justify-content: space-between; padding: 5px 20px;"
          ...
          <div style=" margin-left: 50px;">
            <div class="dx-datagrid-summary-item dx-datagrid-text-content" v-html="customTextSummaryMonth()" />
          </div>
          <div style=" margin-left: 50px;">
            <div class="dx-datagrid-summary-item dx-datagrid-text-content" v-html="customTextSummaryRegular()" />
          </div>
        </div>
      </a-spin>
    </div>
...
const managerCompactUserList = computed(() => dataOrigin.value?.map((i: any) => ({
...
const managerSalesRepresentative = computed(() => dataOrigin.value?.map((i: any) => ({
