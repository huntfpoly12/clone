  ...
  <div class="grid-view">
    ...
    <div class="content-grid">
      <a-spin :spinning="loadingIncomeExtraPayment || loadingElectronicFilings" size="large">
        <DxDataGrid id="DxDataGrid-bf-630-tab4" :show-row-lines="true" :hoverStateEnabled="true" :data-source="dataSource" :show-borders="true"
          ...
          <template #imputed="{ data }">
            <GetStatusTable :beforeProductionRequest="!data.data.lastProductionRequestedAt" :data="data.data" tabName="tab4"
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const dateSubmission = ref(`${globalYear + 1}02${lastDayFeb}`)
    // for checkbox 
