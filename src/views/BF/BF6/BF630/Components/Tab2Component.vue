<template>
  ...
  <div class="grid-view">
    ...
    <div class="content-grid">
      <a-spin
        :spinning="loadingIncomeRetirementPayment || loadingElectronicFilings"
        size="large"
      >
        <DxDataGrid
          id="DxDataGrid-bf-630-tab2"
          :show-row-lines="true"
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const {
      ...
      queries.searchIncomeRetirementPaymentStatementElectronicFilingsByYear,
    ...
    watch(resIncomeRetirementPayment, (value) => {
      ...
      if (value) {
        let data =
          value.searchIncomeRetirementPaymentStatementElectronicFilingsByYear;
