<template>
      ...
      <a-spin :spinning="loadingIncomeWagePayment || loadingElectronicFilings" size="large">
        <DxDataGrid :show-row-lines="true" :hoverStateEnabled="true" :data-source="dataSource" :show-borders="true"
          ...
          <template #imputed="{ data }">
            <GetStatusTable v-if="data.data.lastProductionRequestedAt" :data="data.data" tabName="tab1"
  ...
  <request-file-popup v-if="modalRequestFile" :modalStatus="modalRequestFile" @closePopup="modalRequestFile = false"
    :data="dataRequestFile" tabName="tab1" @onDoneRequest="doneRequestFile"></request-file-popup>
</template>
<script lang="ts">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    } = useQuery(queries.searchIncomeWagePaymentStatementElectronicFilingsByYear, payloadIncomeBusinessPayment, () => ({
