<template>
      ...
      <a-spin :spinning="loadingIncomeWagePayment || loadingElectronicFilings" size="large">
            <DxDataGrid :show-row-lines="true" :hoverStateEnabled="true" :data-source="dataSource"
                ...
                <template #imputed="{data}"> 
                  <get-status-table v-if="data.data.lastProductionRequestedAt" :data="data.data" tabName="tab1" @productionStatusData="productionStatusData"/>
                </template>
  ...
  <request-file-popup v-if="modalRequestFile" :modalStatus="modalRequestFile"  @closePopup="modalRequestFile = false" :data="dataRequestFile" tabName="tab1"></request-file-popup>
</template>
<script lang="ts">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    watch(resIncomeWagePayment, (value : any) => {
      if (value) {
        let data = value.searchIncomeWagePaymentStatementElectronicFilings;
