<template>
      ...
      <a-spin :spinning="loadingIncomeBusinessPayment || loadingElectronicFilings" size="large">
        <DxDataGrid :show-row-lines="true" :hoverStateEnabled="true" :data-source="dataSource" :show-borders="true"
          ...
          <template #imputed="{ data }">
            <GetStatusTable v-if="data.data.lastProductionRequestedAt" :data="data.data" tabName="tab3"
  ...
  <request-file-popup v-if="modalRequestFile" :modalStatus="modalRequestFile" @closePopup="modalRequestFile = false"
    :data="dataRequestFile" tabName="tab3" @onDoneRequest="doneRequestFile"></request-file-popup>
</template>
<script lang="ts">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    } = useQuery(queries.searchIncomeBusinessPaymentStatementElectronicFilingsByYear, payloadIncomeBusinessPayment, () => ({
