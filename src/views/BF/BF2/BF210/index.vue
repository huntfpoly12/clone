    ...
    <div id="bf-210">
            ...
            <div id="components-grid-demo-flex">
                <a-row justify="start" :gutter="[16, 8]">
                    <a-col>
                        ...
                        <a-select ref="select" v-model:value="dataSearch.status" style="width: 150px">
                    ...
                    <a-col style="display: flex; align-items: center;">
                        <a-checkbox v-model:checked="dataSearch.typeSevice1">이용중</a-checkbox>
                        <a-checkbox v-model:checked="dataSearch.typeSevice2">이용중지</a-checkbox>
                    </a-col>
                </a-row>
            </div>
        </div>
        <div class="page-content">
            <DxDataGrid :data-source="dataSource" :show-borders="true" key-expr="ID" @exporting="onExporting">
                ...
                <DxColumn data-field="상태" cell-template="grid-cell" css-class="cell-center" />
