                ...
                <a-row :gutter="24">
                    <a-col :span="12">
                        <a-form-item label="회원ID">
                            ...
                            <button disabled
                                style="background-color: #00000040;color: #918e8b;border: none;height: 32px;">
                                중복체크
                            </button>
                        </a-form-item>
                        ...
                        <a-form-item label="소속">
                            <a-select v-model:value="formState.groupCode" class="select-search" disabled
                                style="width: 230px;" />
                        </a-form-item>
                    </a-col>
                    <a-col :span="12">
                        <a-form-item label="상태">
                            <a-switch v-if="formState.type != 'c'" v-model:checked="formState.active"
                                checked-children="이용중" un-checked-children="이용중지" style="width: 100px" />
                            <a-switch v-if="formState.type == 'c'" disabled v-model:checked="formState.active"
                                checked-children="이용중" un-checked-children="이용중지" style="width: 100px" />
                        </a-form-item>
                ...
                <a-row :gutter="24">
                    <a-col :span="12">
                        ...
                        <a-form-item :name="['user', 'email']" label="이메일" :rules="[{ type: 'email' }]" :span="8">
                            <a-input v-if="formState.type !== 'c'" @change="validateEmail"
                                v-model:value="formState.email" style="width: 230px"
                                :style="!statusMailValidate ? { borderColor: 'red' } : ''" id="email" />
                            <a-input v-if="formState.type == 'c'" disabled v-model:value="formState.email"
                                style="width: 230px" />
                            ...
                            <a-button v-if="formState.type !== 'c'" html-type="submit" danger class="btn_sendemail"
                                @click="showModal">
                                비밀번호 변경</a-button>
                            <a-button v-if="formState.type == 'c'" disabled html-type="submit" danger
                                class="btn_sendemail">비밀번호 변경
                            </a-button>
                        </a-form-item>
