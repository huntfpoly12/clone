    ...
    watch(result, (value) => {
      if (value && value.getUser) {
        ...
        formState.value.type =
          value.getUser.type != "m"
            ? value.getUser.type
            : value.getUser.managerGrade;
        ...
        if (value.getUser.type == "m" && value.getUser.managerGrade == "3")
          typeSelect.value = 2;
        if (value.getUser.type == "r") typeSelect.value = 3;
        if (value.getUser.type == "p") typeSelect.value = 4;
        if (value.getUser.type == "c") typeSelect.value = 5;
