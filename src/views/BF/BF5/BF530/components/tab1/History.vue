    ...
    <section class="mt-20">
      <a-spin :spinning="loading1">
        <DxDataGrid :show-row-lines="true" :hoverStateEnabled="true" :data-source="dataSource" :show-borders="true"
          ...
          <DxColumn caption="수임상태" data-field="companyConsignStatus" :format="consignStatusText" alignment="center"/>
          <DxColumn caption="처리상태" data-field="workingStatus"/>
          <DxColumn caption="연금EDI상태" data-field="nationalPensionEDIStatus" :format="EDIStatusText" alignment="center"/>
          <DxColumn caption="건보EDI상태" data-field="healthInsuranceEDIStatus" :format="EDIStatusText" alignment="center"/>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return {
      ...
      colomn_resize,
      dataSource,loading1,
      workStatusText, consignStatusText, EDIStatusText,
    };
  },
});
</script>
