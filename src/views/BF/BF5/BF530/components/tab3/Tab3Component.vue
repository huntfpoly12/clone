  ...
  <div class="tab-group">
      ...
      <a-row :gutter="[0, 5]">
        <a-rol class="mr-20">
          <a-form-item label="업체명">
            <default-text-box
              width="150px"
              v-model:valueInput="formState.companyName1"
            />
          </a-form-item>
        </a-rol>
        <a-rol class="mr-20">
          <a-form-item label="사업장관리번호">
            <biz-number-text-box
              width="150px"
              v-model:valueInput="formState.companyName2"
            />
          </a-form-item>
        </a-rol>
        <a-rol class="mr-20">
          <a-form-item label="상태">
            <select-box-common
              :arrSelect="reportTypeSelectbox2"
              v-model:valueInput="formState.companyName4"
              displayeExpr="text"
              valueExpr="id"
              width="150px"
              placeholder="사업유형 선택"
    ...
    <div class="content-grid">
      ...
      >
        ...
        <DxColumn caption="일련번호" data-field="companyId" />
        <DxColumn caption="신고구분" data-field="type" />
        ...
        <DxColumn caption="사원주민번호" data-field="employeeId" width="125" />
        <DxColumn
          caption="신청일"
