...
export default defineComponent({
    ...
    setup() {
        ...
        const cloneWebsite = () => {
          ...
          if(userToken.value){
            window.open(`${currentUrl}/dashboard?token=${userToken.value.accessToken}&refreshToken=${userToken.value.refreshToken}&companyId=${companyInfo.companyId}&companyName=${companyInfo.name}&path=Example&typeLogin=custom`, '_blank',  windowFeatures);
          }
        }
