            ...
            <form action="your-action">
                ...
                <a-row>
                    <a-col :span="15" :md="13" :lg="12">
                        <a-form-item class="result-address" :wrapper-col="{ span: 24 }" label-align="right"
                            :label-col="labelCol">
                            <default-text-box v-model:valueInput="formState.roadAddress" width="100%" :disabled="true"
                                :required="true" placeholder="우편번호" />
                        </a-form-item>
                    </a-col>
                ...
                <a-row>
                    <a-col :span="10">
                        <a-form-item label="세금계산서발행여부" :label-col="{ span: 8 }" label-align="right">
                            <switch-basic v-model:valueSwitch="formState.taxInvoice" textCheck="발행" textUnCheck="미발행"
                                style="width: 80px" />
                        </a-form-item>
                    </a-col>
                    <a-col :span="14">
                ...
                <a-row style="margin-top: 20px;">
                    <a-col :span="16" :offset="8">
                        ...
                        <button-basic text="저장하고 나가기" :type="'default'" mode="'contained'" @onClick="createSale($event)"
                            :width="150" />
                    </a-col>
                </a-row>
            </form>
