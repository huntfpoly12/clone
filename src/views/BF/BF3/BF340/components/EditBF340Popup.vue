                ...
                <a-row :gutter="24">
                    <a-col :span="9" :md="13" :lg="10">
                        ...
                        <a-form-item label="영업자명" class="red" label-align="right" :label-col="labelCol">
                            <default-text-box v-model:valueInput="formState.name" width="200px"  :disabled="!canChangeCompanyName" :required="true" />
                        </a-form-item>
                    ...
                    <a-col :span="15" :md="11" :lg="14">
                        ...
                        <a-form-item label="사업자등록번호" label-align="right" :label-col="labelCol">
                            <company-registration-number-text-box v-model:valueInput="formState.bizNumber"  messRequired="이항목은 필수 입력사항입니다!" />
                        </a-form-item>
