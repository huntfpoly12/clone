<template>
  <div id="modal-detail-bf-310">
    ...
    >
          ...
          <div class="collapse-content">
            ...
            >
                ...
                <a-row>
                  ...
                  <a-col :span="24" style="display: flex">
                    ...
                    >
                      <default-text-box
                        :valueInput="
                          isNumeric(formState.processedAt)
                    ...
                    <a-form-item label-align="left" style="padding-left: 10px">
                      <default-text-box
                        v-model:valueInput="formState.processedBy"
                        :disabled="true"
                        width="200px"
                      />
                    </a-form-item>
                  ...
                  <a-col :span="24" style="display: flex">
                    ...
                    >
                      <default-text-box
                        :valueInput="
                          isNumeric(formState.rejectedAt)
                    ...
                    <a-form-item label-align="left" style="padding-left: 10px">
                      <default-text-box
                        v-model:valueInput="formState.rejectedBy"
                        :disabled="true"
                        width="200px"
                      />
                    </a-form-item>
                  ...
                  <a-col :span="24" style="display: flex">
                    ...
                    >
                      <default-text-box
                        :valueInput="
                          isNumeric(formState.approvedAt)
                    ...
                    <a-form-item label-align="left" style="padding-left: 10px">
                      <default-text-box
                        v-model:valueInput="formState.approvedBy"
                        :disabled="true"
                        width="200px"
                      />
                    </a-form-item>
                  ...
                  <a-col :span="24" style="display: flex">
                    ...
                    >
                      <default-text-box
                        v-model:valueInput="formState.code"
                        :disabled="true"
                        width="200px"
                      />
                    </a-form-item>
                  ...
                  <a-col :span="24">
                    ...
                    >
                      <text-area-box
                        v-model:valueInput="formState.memo"
                        width="100%"
                      />
                    </a-form-item>
                  </a-col>
              ...
              <a-collapse-panel key="2" header="사업자정보" class="key-2">
                <a-row :gutter="24" style="height: 350px; overflow-y: scroll">
                  <a-col :span="9">
                    ...
                    >
                      <default-text-box
                        v-model:valueInput="formState.content.company.name"
                        width="220"
                        :required="true"
                    ...
                    >
                      <biz-number-text-box
                        ...
                        v-model:valueInput="formState.content.company.bizNumber"
                        width="220"
                        :required="true"
                        messRequired="이항목은 필수 입력사항입니다!"
                    ...
                    >
                      <radio-group
                        :arrayValue="bizTypeItems"
                        v-model:valueRadioCheck="
                          formState.content.company.bizType
                        "
                    ...
                    <a-form-item
                      :label="
                        changeTypeCompany(formState.content.company.bizType)
                      "
                      label-align="left"
                      :label-col="{ span: 9 }"
                    >
                    ...
                    >
                      <a-row :gutter="[0, 4]">
                        <a-col :span="24" style="display: flex">
                          <default-text-box
                            v-model:valueInput="
                              formState.content.company.zipcode
                            "
                            width="70px"
                            :disabled="true"
                          />
                        ...
                        <a-col :span="24">
                          <default-text-box
                            v-model:valueInput="
                              formState.content.company.roadAddress
                            "
                            width="220"
                            :disabled="true"
                          />
                        ...
                        <a-col :span="24">
                          <default-text-box
                            v-model:valueInput="
                              formState.content.company.addressExtend
                            "
                            width="220"
              ...
              <a-collapse-panel key="3" header="대표자정보">
                ...
                >
                  <default-text-box
                    v-model:valueInput="formState.content.president.name"
                    width="200px"
                    :required="true"
                    messRequired="이항목은 필수 입력사항입니다!"
                ...
                >
                  <birth-day-box
                    v-model:valueInput="formState.content.president.birthday"
                    width="200px"
                  />
                </a-form-item>
                <a-form-item
                ...
                >
                  <text-number-box
                    v-model:valueInput="formState.content.president.mobilePhone"
                    :required="true"
                    width="200px"
                    placeholder="‘-’ 없이 슷자입력"
                    messRequired="이항목은 필수 입력사항입니다!"
                ...
                >
                  <mail-text-box
                    v-model:valueInput="formState.content.president.email"
                    width="350px"
                    :required="true"
                    messRequired="이항목은 필수 입력사항입니다!"
                    nameInput="president-email"
                  />
                </a-form-item>
              </a-collapse-panel>
              <a-collapse-panel
                key="4"
                header="회계서비스신청"
                class="popup-scroll key-4"
              >
                <div style="height: 350px; overflow-y: scroll">
                  <checkbox-basic
                    v-model:valueCheckbox="formState.usedAccounting"
                    :disabled="false"
                    size="15"
                    label="회계서비스 신청합니다."
                  />
                  <div>
                    ...
                    <div id="data-grid-demo">
                      ...
                      >
                        ...
                        >
                          <DxLookup
                            :data-source="facilityBizTypeCommon"
                            value-expr="v"
                            display-expr="n"
                          />
                        </DxColumn>
                        <DxColumn
                          cell-template="startYearMonth"
                          caption="서비스시작년월"
                          data-type="date"
                        />
                      ...
                      >
                        <a-col :span="9">
                          <a-form-item label="사업분류" :label-col="labelCol">
                            <select-box-common
                              :arrSelect="facilityBizTypeCommon"
                              :required="true"
              ...
              <a-collapse-panel key="5" header="원천서비스신청">
                <div>
                  ...
                  <radio-group
                    :arrayValue="arrayRadioCheckSourceServices"
                    v-model:valueRadioCheck="checkedSourceService"
                    :layoutCustom="'horizontal'"
                  />
                  <div style="margin-top: 20px">
                    ...
                    >
                      <number-box
                        ...
                        :spinButtons="true"
                        v-model:valueInput="
                          formState.content.withholding.capacity
                        "
                        :disabled="checkedSourceService == 2"
                        messRequired="이항목은 필수 입력사항입니다!"
                      />
              ...
              >
                ...
                >
                  <bank-select-box
                    v-model:valueInput="formState.content.cmsBank.bankType"
                    width="150px"
                  />
                </a-form-item>
                <a-form-item
                ...
                <a-form-item
                  label="사업자(주민)등록번호:"
                  class="d-flex align-items-start clr"
                  label-align="left"
                  :label-col="labelCol"
                >
                  <biz-number-text-box
              ...
              <a-collapse-panel key="7" header="기타">
                ...
                >
                  <text-area-box
                    v-model:valueInput="formState.content.extra.comment"
                    :width="750"
                    :height="70"
                    placeholder="전달사항입력"
                  />
          ...
          <a-row style="margin-top: 20px">
            <a-col :span="24" :offset="8">
              ...
              <button-basic
                ...
                type="default"
                mode="contained"
                @onClick="updateSubscriptionRequest($event)"
                :width="150"
              />
            </a-col>
          </a-row>
      ...
      <PopupInfo
        :statusPupopInfo="statusPupopInfo"
        @closePopup="statusPupopInfo = false"
        :keyText="keyInfo"
      />
    </a-modal>
  </div>
