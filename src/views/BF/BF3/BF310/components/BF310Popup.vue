<template>
  <div id="modal-detail-bf-310">
    <a-modal :mask-closable="false" v-model:visible="visible" title="계약정보관리&심사 " centered @cancel="setModalVisible()"
      width="1000px" :bodyStyle="{ height: '800px' }">
      <template #footer>
        <a-button @click="setModalVisible">그냥 나가기</a-button>
        <a-button key="submit" type="primary" :loading="loading || loadingUpdate" @click="updateSubscriptionRequest">
          저장하고 나가기</a-button>
      </template>
          ...
          <a-collapse v-model:activeKey="activeKey" accordion>
              ...
              <a-form-item label="승인상태">
                <a-dropdown :trigger="['hover']">
                  ...
                  <template #overlay>
                    ...
                    ]" :data-source="dataStatus" :pagination="false" :showHeader="false" :customRow="customRow">
            ...
            <a-collapse-panel key="2" header="사업자정보">
              <div style="height: 400px; overflow-y: scroll">
                ...
                <a-form-item label="사업자등록번호" class="clr">
                  <number-box width="300px" :disabled="!canChangeableBizNumber"
                    v-model:valueInput="formState.companyBizNumber" :rtlEnabled="false" mode="text" />
                </a-form-item>
                <a-row>
                  <a-col :span="12">
                ...
                <a-form-item label="주소" class="clr">
                  <a-row :gutter="[0, 4]">
                    <a-col :span="24">
                      <a-row>
                        <a-col :span="12">
                          <a-input style="width: 100%" v-model:value="formState.companyZipcode" disabled
                            placeholder="우편번호" />
                        </a-col>
                        <a-col :span="12">
                    ...
                    <a-col :span="24">
                      <a-row>
                        <a-input v-model:value="formState.companyRoadAddress" disabled />
                      </a-row>
                    </a-col>
                    <a-col :span="24">
                      <a-row>
                        <a-input v-model:value="formState.companyAddressExtend" placeholder="상세주소 (입력)" />
                      </a-row>
                    </a-col>
                  </a-row>
                  <a-row> </a-row>
                    ...
                    <a-row :gutter="[16, 16]">
                      <a-col :span="15">
                        <a-form-item label="연락처" class="clr">
                          <a-input v-model:value="formState.companyPhone" placeholder="‘-’없이 숫자만 입력" />
                        </a-form-item>
                        <a-form-item label="팩 스">
                          <a-input v-model:value="formState.companyFax" placeholder="‘-’없이 숫자만 입력" />
                        </a-form-item>
                      </a-col>
                    </a-row>
            ...
            <a-collapse-panel key="3" header="대표자정보">
              <a-form-item has-feedback label="대표자명" class="clr">
                <a-input autocomplete="off" style="width: 300px" v-model:value="formState.presidentContentName" />
              </a-form-item>
              <a-form-item has-feedback label="생년월일" class="clr">
                <a-input autocomplete="off" style="width: 300px" v-model:value="formState.presidentBirthday" />
              </a-form-item>
              <a-form-item has-feedback label="휴대폰번호" class="clr">
                <a-input placeholder="‘-’없이 숫자만 입력" style="width: 200px" v-model:value="formState.presidentPhone" />
              </a-form-item>
                ...
                <div>
                  ...
                  <div id="data-grid-demo">
                    <DxDataGrid id="gridContainer" :data-source="formState.accountingfacilityBusinesses"
                      ...
                      <DxColumn data-field="startYearMonth" caption="서비스시작년월" data-type="date" :format="'yyyy-MM-dd'" />
                  ...
                  <a-form-item label="장기요양기관등록번호" class="clr">
                    <a-input placeholder="‘-’없이 숫자만 입력" style="width: 250px" v-model:value="
                ...
                <div style="margin-top: 20px">
                  <a-form-item label="서비스 시작년월" class="clr">
                    <div style="width: 200px">
                      <month-picker-box v-model:value="formState.withholdingYearMonth" className="0" />
                    </div>
                  </a-form-item>
                  <a-form-item label="직 원 수" class="clr">
                    <number-box width="100px" :min="0" :spinButtons="true"
            ...
            <a-collapse-panel key="7" header="기타">
              <a-form-item label="영업관리담당">
                <ListSalesDropdown v-model:selected="formState.extraSalesRepresentativeId" width="200px" />
              </a-form-item>
