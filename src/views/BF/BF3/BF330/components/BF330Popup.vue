            ...
            <a-row>
              <a-col :span="10">
                <a-form-item label="총일용료" style="font-weight: bold">
                  <a-input
                    v-model:value="formState.totalService"
                    disabled="True"
                  />
                </a-form-item>
              </a-col>
              ...
              <a-col :span="10">
                ...
                >
                  <a-input
                    v-model:value="formState.accFeeService"
                    disabled="True"
                  />
                </a-form-item>
              </a-col>
              ...
              <a-col :span="10">
                ...
                >
                  <a-input
                    v-model:value="formState.taxFeeSevice"
                    disabled="True"
                  />
                </a-form-item>
              </a-col>
                    ...
                    <template v-else-if="column.key === '사업분류'">
                      <span>
                        ...
                        >
                          ...
                          >
                          <a-select-option value="인지활동형 방문요양"
                            >인지활동형 방문요양</a-select-option
                          >
              ...
              <a-col :span="14">
                <div style="display: flex; padding-left: 155px">
                  <span style="width: 180px">
                    <input
                      type="checkbox"
                      v-model="formState.checkBoxAccBasicFee"
                    />
                    기본이용료</span
                  >
              ...
              <a-col :span="14">
                ...
                >
                  <span style="width: 180px">
                    <input
                      type="checkbox"
                      v-model="formState.checkBoxAccInput"
                    />
                    입력대형
                  </span>
              ...
              <a-col :span="14">
                ...
                >
                  <span style="width: 180px">
                    <input
                      type="checkbox"
                      v-model="formState.checkBoxAccConso"
                    />
                    계좌통합
                  </span>
            ...
            <a-col :span="14">
              <div style="display: flex; padding-left: 155px; margin-top: 5px">
                <span style="width: 180px">
                  <input
                    type="checkbox"
                    v-model="formState.checkBoxMajorInsurance"
                  />
                  4대보험</span
                >
...
export default defineComponent({
  ...
  watch: {
    formState: {
      handler(value) {
        if (
          this.formState.accFeeService != 0 &&
          this.formState.taxFeeSevice != 0
        ) {
          this.formState.totalService =
            this.formState.taxFeeSevice + this.formState.accFeeService;
        }
        if (
          this.formState.checkBox == true &&
          this.formState.accBasicFee != "" &&
          this.formState.accConsolidation != "" &&
          this.formState.accInput != "" &&
          this.formState.acc4wc != ""
        ) {
          this.formState.accFeeService =
            parseInt(this.formState.accBasicFee) +
            parseInt(this.formState.accConsolidation) +
            parseInt(this.formState.accInput) +
            parseInt(this.formState.acc4wc);
        }
        if (
          this.formState.checkBox == true &&
          this.formState.basicFee != "" &&
          this.formState.majorInsurance != ""
        ) {
          this.formState.taxFeeSevice =
            parseInt(this.formState.basicFee) +
