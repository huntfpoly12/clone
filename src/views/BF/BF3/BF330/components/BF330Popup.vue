    ...
    <div id="components-modal-demo-position">
        <a-modal :visible="modalStatus" :mask-closable="false" title="서비스관리 " centered okText="저장하고 나가기"
            ...
            <template #footer>
                ...
                <a-button key="submit" type="primary" :loading="loading || loadingUpdate" @click="updateServiceContract">
                    저장하고 나가기</a-button>
            </template>
            <a-collapse v-model:activeKey="activeKey" accordion>
                        ...
                        <div>
                            <a-form :label-col="labelCol" :wrapper-col="wrapperCol">
                                ...
                                <a-form-item label="직 원 수 ">
                                    <a-input-number type="number" min="0" v-model:value="formState.withholdingCapacity"
                                        style="width: 150px" />
                                </a-form-item>
                        ...
                        <a-row>
                            ...
                            <a-col :span="14">
                                <div style="display: flex; padding-left: 155px">
                                    ...
                                    <DxNumberBox v-model="formState.usedServiceInfoWithholdingPrice" :format="'#,##0'"
                ...
                <a-collapse-panel key="3" header="메모" :extra="formStateMomes.length > 0 ? formStateMomes.length : ''"
    ...
    setup(props,{emit}) {
        ...
        watch(result, (value) => {
            if (value && value.getServiceContract) {
                ...
                formState.withholdingStartYearMonth = value.getServiceContract.withholding.startYearMonth;
                formState.withholdingCapacity = value.getServiceContract.withholding.capacity;
                formState.compactSalesRepresentativeId = value.getServiceContract.salesRepresentativeId;
                ...
                formState.usedServiceInfoWithholdingPrice = value.getServiceContract.usedServiceInfo.withholding.price;
                formState.checkBoxBasicFee = true;
                if (value.getServiceContract.usedServiceInfo.withholding.options.length > 0) {
                    value.getServiceContract.usedServiceInfo.withholding.options.map((val: any) => {
        ...
        } = useMutation(mutations.updateServiceContractManageMemo);
        ...
        const {
            ...
            onDone: onDeleteMemo
        } = useMutation(mutations.deleteServiceContractManageMemo);
