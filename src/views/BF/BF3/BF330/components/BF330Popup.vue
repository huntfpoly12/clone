              ...
              <a-row>
                <a-col>
                  <a-form-item label="원천서비스" style="font-weight: bold">
                    <a-checkbox v-model:checked="formState.usedWithholding"
                      >원천서비스</a-checkbox
                    >
                  </a-form-item>
                </a-col>
              ...
              <div>
                <a-form :label-col="labelCol" :wrapper-col="wrapperCol">
                  <a-form-item label="서비스 시작년월" style="width: 300px">
                    <CustomDatepicker
                      :valueDate="formState.withholdingStartYearMonth"
              ...
              <a-row>
                ...
                <a-col :span="14">
                  <div style="display: flex; padding-left: 155px">
                    ...
                    >
                    <DxNumberBox
                      v-model="formState.usedServiceInfoWithholdingPrice"
                      :format="'#,##0'"
                ...
                <a-col :span="14">
                  ...
                  >
                    ...
                    >
                    <DxNumberBox
                      v-model="formState.fourMajorInsurance"
                      :format="'#,##0'"
            ...
            <a-form :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-form-item label="담당매니저">
                <div style="width: 200px">
                  <ListManagerDropdown
                    v-model:selected="formState.manageUserId"
                  />
                </div>
              </a-form-item>
              <a-form-item label="영업자">
                <div style="width: 200px">
                  <ListSalesDropdown
                    v-model:selected="formState.compactSalesRepresentativeId"
                  />
                </div>
              </a-form-item>
            </a-form>
