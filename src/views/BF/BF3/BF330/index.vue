    ...
    <div id="bf-310">
      <div class="search-form">
        <a-row :gutter="[8,8]">
          ...
          <a-col>
            ...
            <a-select mode="tags" ref="select" style="width: auto; min-width: 135px;" v-model:value="statuses"
              placeholder="전체">
      ...
      <div class="page-content">
        <DxDataGrid :data-source="dataSource" :show-borders="true" key-expr="id" @exporting="onExporting"
          ...
          <DxColumn :width="170" data-field="compactSalesRepresentative.code" caption="사업자코드" css-class="cell-center" />
