<template>
  <div id="bf-310">
      ...
      <div id="components-grid-demo-flex">
        <a-row justify="start" :gutter="[16, 8]">
          <a-col>
            ...
            <a-input
              style="width: 120px"
              v-model:value="dataSearch.typeSevice"
            />
          </a-col>
          <a-col>
          ...
          <a-col>
            ...
            <a-switch
              v-model:checked="dataSearch.status"
              checked-children="포함"
          ...
          <a-col>
            ...
            <a-select
              style="width: 120px"
              v-model:value="dataSearch.manager"
              show-search
              placeholder="매니저명"
              :options="options"
            >
    ...
    <div class="page-content">
      ...
      />
      <BF330Popup
        :modalStatusHistory="modalStatusHistory"
        @closePopupHis="modalStatusHistory = false"
        :data="popupData"
      />
    </div>
  </div>
