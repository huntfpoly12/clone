			...
			<div id="content" class="dx-theme-background-color">
				<a-spin :spinning="loadingGetAccountingDocuments">
					<DxDataGrid noDataText="내역이 없습니다" id="dataGridAc120"
						...
						<DxRowDragging
							:allow-reordering="(userType !== 'm' && status === 10) || (userType === 'm' && status !== 40)"
								...
								<a-tooltip placement="top" color="black">
									...
									<span>
										<DxButton class="ml-4 custom-button" type="default"
											:disabled="(userType !== 'm' && status !== 10) || (userType === 'm' && status === 40)"
						...
						<DxColumn caption="정상 여부" :allow-sorting="false" css-class="cell-center"
							cell-template="resolutionNormalStatus" width="75" />
...
export default defineComponent({
    ...
    const status = computed(() => dataGetAccountingProcesses.value.find((item: any) => item.month === monthSelected.value)?.status)
