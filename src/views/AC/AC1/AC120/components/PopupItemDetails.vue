<template>
  ...
  >
    ...
    <div class="btn_submit text-align-center mt-20">
      <button-basic
        :disabled="disabledSubmit || !dataSource?.length"
        @onClick="onSubmit"
    ...
    <PopupMessage
      ...
      :typeModal="'confirm'"
      :title="Message.getMessage('AC110', '005').message"
      content=""
      :okText="Message.getMessage('AC110', '005').yes"
      :cancelText="Message.getMessage('AC110', '005').no"
