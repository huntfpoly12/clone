            ...
            <a-row class="mt-20">
              ...
              <a-col :span="5" class="col-2">
                <a-form-item label="결의일자" class="red">
                  <date-time-box :teleport="true" v-model:valueDate="formData.transactionDetailDate" width="130px"
                    :required="true" disabled="true" />
                </a-form-item>

                <a-form-item label="통장" class="red">
                  <default-text-box v-model:valueInput="bankbookNickname" width="130px" style="margin-right: 10px"
                    :required="true" disabled="true" />
                </a-form-item>
              </a-col>
              ...
              <a-col :span="6" class="col-4 fl-r">
                ...
                <a-form-item label="자금원천" class="red">
                  <FundingSourceSelect v-model:valueInput="formData.fundingSource" width="230px" :required="true" />
                </a-form-item>
              </a-col>
              <a-col :span="7" class="col-1">
                <a-form-item label="원인행위일자" class="red" :class="colorDate">
                  <date-time-box :teleport="true" v-model:valueDate="formData.causeActionDate" width="150px"
                    :required="true" ref="requiredCauseActionDate" />
                </a-form-item>
                <a-form-item label="결재일자">
                  <date-time-box :teleport="true" v-model:valueDate="formData.paymentDate" width="150px" />
                </a-form-item>
                <a-form-item label="발의일자">
                  <date-time-box :teleport="true" v-model:valueDate="formData.proposedDate" width="150px" />
                </a-form-item>
              </a-col>
              <a-col :span="5" class="col-2">
                <a-form-item :label="null" style="margin-left: 75px">
                  <default-text-box v-model:valueInput="bankbookNumber" width="130px" :required="true" disabled="true" />
                </a-form-item>

                <a-form-item label="출납일자">
                  <date-time-box :teleport="true" v-model:valueDate="formData.accountingDate" width="130px" />
                </a-form-item>
                <a-form-item label="등기일자">
                  <date-time-box :teleport="true" v-model:valueDate="formData.registrationDate" width="130px" />
                </a-form-item>
              </a-col>
              <a-col :span="6" class="col-3">
              ...
              <a-col :span="6" class="col-4 fl-r">
                <a-form-item label="상대계정">
                  <account-code-select :key="resetSelectAccount" :disabled="formData.resolutionClassification == 1"
                    :classification="classificationRelationCode" v-model:valueInput="formData.relationCode"
                    width="230px" />
                </a-form-item>
            ...
            <a-row>
              <a-col :span="12">
                <a-form-item class="red" label="품의종류">
                  <radio-group :disabled="formData.resolutionClassification == 1"
                    v-model:valueRadioCheck="formData.letterOfApprovalType" :arrayValue="arrayRadioCheck"
                    :layoutCustom="'horizontal'" :required="true" />
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item label="물품내역수">
                  <default-text-box :disabled="true" v-model:valueInput="formData.goodsCount" width="150px" />
                </a-form-item>
              </a-col>
            </a-row>
            <a-row>
              <a-col :span="24">
                <a-form-item label="품의 원인 및 용도">
                  <text-area-box :disabled="formData.resolutionClassification == 1"
