  ...
  <a-modal :visible="modalStatus" @cancel="cancel" :mask-closable="false" class="confirm-md" footer="" :width="1600">
    <div class="mt-20" :key="countKey">
      <standard-form formName="ac-120-form-add" ref="refFormAddAC120" class="text-align-center mt-20">
        ...
        <a-row class="mt-20">
          <a-col :span="7" class="col-1">
            ...
            <a-form-item class="red" label="결의서 종류">
              <radio-group :arrayValue="store.state.common.ac120.arrResolutionType" :layoutCustom="'horizontal'"
                :required="true" v-model:valueRadioCheck="formDataAdd.resolutionType"
          ...
          <a-col :span="6" class="col-3">
            <a-form-item class="red" label="적요">
              <default-text-box :width="150" :required="true" v-model:valueInput="formDataAdd.summary" placeholder="적요" />
            </a-form-item>
          ...
          <a-col :span="6" class="col-2">
            ...
            <a-form-item label="등기일자">
              <date-time-box :teleport="true" v-model:valueDate="formDataAdd.registrationDate" width="150px" />
            </a-form-item>
          </a-col>
          <a-col :span="6" class="col-3">
        ...
        <div class="mt-20">
          <button-basic class="button-form-modal" :text="'아니요'" :type="'default'" :mode="'outlined'" @onClick="cancel" />
