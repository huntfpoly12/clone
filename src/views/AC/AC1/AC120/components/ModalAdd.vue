        ...
        <a-row class="mt-20">
          <a-col :span="7" class="col-1">
            <a-form-item class="red" label="결의일자">
              ...
              <date-time-box-custom
                ...
                :required="true"
                :startDate="startDate"
                ref="requiredTransactionDetailDate"
            ...
            <a-form-item class="red" label="결의서 종류">
              <radio-group
                :arrayValue="store.state.common.ac120.arrResolutionType"
          ...
          <a-col :span="6" class="col-2">
            <a-form-item class="red" label="통장">
              <select-box-common
                placeholder="선택"
                :arrSelect="store.state.common.ac120.arrayBankbooks"
                v-model:valueInput="formDataAdd.bankbookId"
                :required="true"
                :width="150"
              />
            </a-form-item>
            <a-form-item class="red" label="금액">
              <number-box-money
                ...
                :required="true"
                :min="0"
                v-model:valueInput="formDataAdd.amount"
                placeholder="금액"
              />
            </a-form-item>
          ...
          <a-col :span="6" class="col-3">
            <a-form-item class="red" label="적요">
              <default-text-box
                :width="150"
                :required="true"
                v-model:valueInput="formDataAdd.summary"
                placeholder="적요"
              />
            </a-form-item>
          ...
          <a-col :span="5" class="col-4">
            ...
            <a-form-item label="계정과목" class="red">
              <account-code-select
                ...
                v-model:valueInput="formDataAdd.accountCode"
                width="190px"
                :required="true"
              />
            </a-form-item>
          ...
          <a-col :span="7" class="col-1">
            <a-form-item label="원인행위일자" class="red" :class="colorDate">
              <date-time-box
                :teleport="true"
                v-model:valueDate="formDataAdd.causeActionDate"
                width="150px"
                :required="true"
            ...
            <a-form-item label="결재일자">
              <date-time-box
                :teleport="true"
                v-model:valueDate="formDataAdd.paymentDate"
                width="150px"
              />
            </a-form-item>
            <a-form-item label="발의일자">
              <date-time-box
                :teleport="true"
                v-model:valueDate="formDataAdd.proposedDate"
                width="150px"
              />
            </a-form-item>
          </a-col>
          <a-col :span="6" class="col-2">
            ...
            <a-form-item label="출납일자">
              <date-time-box
                :teleport="true"
                v-model:valueDate="formDataAdd.accountingDate"
                width="150px"
              />
            </a-form-item>
            <a-form-item label="등기일자">
              <date-time-box
                :teleport="true"
                v-model:valueDate="formDataAdd.registrationDate"
                width="150px"
              />
            </a-form-item>
          </a-col>
          <a-col :span="6" class="col-3">
            <a-form-item label="거래처">
              <customer-select
                ...
                v-model:valueInput="formDataAdd.clientId"
                width="150px"
              />
            </a-form-item>
            <div class="input_info">
              <a-form-item :label="textLabelInputSource">
                <default-text-box
                  v-model:valueInput="formDataAdd.source"
                  width="150px"
                />
              </a-form-item>
            ...
            <div class="input_info">
              <a-form-item label="작성자">
                <default-text-box
                  v-model:valueInput="formDataAdd.writer"
                  width="150px"
                />
              </a-form-item>
              <a-tooltip placement="top" color="black" class="fz-10 ml-10 mb-5">
          ...
          <a-col :span="5" class="col-4">
            <a-form-item label="상대계정">
              <account-code-select
                :key="resetSelectAccount"
                :disabled="formDataAdd.resolutionClassification == 1"
                v-model:valueInput="formDataAdd.relationCode"
            ...
            <a-form-item label="메모">
              ...
              <text-area-box
                width="190px"
                v-model:valueInput="formDataAdd.memo"
                :height="60"
              />
            </a-form-item>
          </a-col>
          ...
          <a-col :span="12">
            <a-form-item class="red" label="품의종류">
              <radio-group
                :disabled="formDataAdd.resolutionClassification == 1"
                v-model:valueRadioCheck="formDataAdd.letterOfApprovalType"
                :arrayValue="store.state.common.ac120.arrLetterOfApprovalType"
                :layoutCustom="'horizontal'"
                :required="true"
              />
            </a-form-item>
        ...
        <a-row>
          <a-col :span="24">
            <a-form-item label="품의 원인 및 용도">
              <text-area-box
                :disabled="formDataAdd.resolutionClassification == 1"
                v-model:valueInput="formDataAdd.causeUsage"
                :height="50"
              />
            </a-form-item>
          </a-col>
