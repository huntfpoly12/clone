<template>
  ...
  <div id="ac-570">
        ...
        <a-col span="24" class="data-table">
          <a-spin :spinning="loadingGetBudgetSubjectTransitions" size="large">
            ...
            >
              ...
              <DxColumn
                caption="전용일자"
                data-field="transitionDate"
                cell-template="transitionDate"
              />
              ...
              <DxColumn
                caption="관"
                cell-template="customDxColumn2"
                data-field="sourceCode1"
              />
              ...
              <DxColumn
                caption="항"
                cell-template="customDxColumn3"
                data-field="sourceCode2"
              />
              ...
              <DxColumn
                caption="목"
                cell-template="customDxColumn4"
                data-field="sourceCode3"
              />
              ...
              <DxColumn
                caption="세목"
                cell-template="customDxColumn5"
                data-field="sourceCode"
              />
              ...
              <DxColumn
                caption="예산액"
                cell-template="customDxColumn6"
                data-field="sourceBudgetAmount"
              />
              ...
              <DxColumn
                caption="전용액"
                data-field="transitionAmount"
                cell-template="customDxColumn7"
              />
              ...
              <DxColumn
                caption="지출액"
                cell-template="customDxColumn9"
                data-field="sourceExpenditureAmount"
              />
              ...
              <DxColumn
                caption="불용액"
                cell-template="customDxColumn10"
    ...
    <DetailPopup
      ...
      @closePopup="modalStatusDetail = false"
      :dataDetail="popupData"
      @callApi="trigger = true"
    />
    <EmailGroupPopup
      :modalStatus="modalEmailGroupStatus"
      @closePopup="modalEmailGroupStatus = false"
