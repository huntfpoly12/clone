        ...
        >
          ...
          <a-row>
            ...
            <a-col :span="13">
              ...
              >
                <date-time-box
                  width="145px"
                  v-model:valueDate="formState.transitionDate"
          ...
          <div class="top-content gray">
            <a-typography-title :level="5" style="margin-bottom: 0"
              >원천계정과목</a-typography-title
            >
          </div>
          <div class="custom-center">
            <a-form-item label="원천계정과목" :label-col="labelCol" class="red">
              <account-code-select
                v-model:valueInput="formState.sourceCode"
                width="150px"
                :required="true"
                disabled="true"
              />
            ...
            <a-form-item label="예산액" :label-col="labelCol">
              <number-box-money
                width="150px"
                :min="0"
                v-model:valueInput="formState.sourceBudgetAmount"
              />
            </a-form-item>
          ...
          <div class="custom-center">
            ...
            <a-form-item label="예산액" :label-col="labelCol">
              <number-box-money
                width="150px"
                :min="0"
                v-model:valueInput="formState.transitionBudgetAmount"
              />
            </a-form-item>
            <a-form-item label="전용액" :label-col="labelCol" class="red">
              <number-box-money
            ...
            <a-form-item label="예산현액" :label-col="labelCol">
              <number-box-money
                ...
                disabled="true"
                :valueInput="
                  formState.transitionBudgetAmount + formState.transitionAmount
                "
              />
            </a-form-item>
            <a-form-item label="지출액" :label-col="labelCol">
            ...
            <a-form-item label="불용액" :label-col="labelCol">
              <number-box-money
                ...
                disabled="true"
                :valueInput="
                  formState.transitionBudgetAmount +
                  formState.transitionAmount -
                  formState.transitionExpenditureAmount
                "
              />
            </a-form-item>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const {
      mutate: updateBudgetSubjectTransition,
      onDone: doneUpdateBudgetSubjectTransition,
      onError: errorUpdateBudgetSubjectTransition,
    ...
    const {
      mutate: createBudgetSubjectTransition,
      onDone: doneCreateBudgetSubjectTransition,
      onError: errorCreateBudgetSubjectTransition,
