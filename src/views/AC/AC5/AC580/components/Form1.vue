    ...
    <standard-form>
      <div class="form-container">
        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="계정과목" label-align="right" class="red">
              <default-text-box width="200px" :disabled="true" v-model:valueInput="formState.presidentName"
                :required="true" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="후원금 종류" label-align="right" class="red">
          ...
          <a-col :span="24">
            <a-form-item label="금액" label-align="right" class="red">
              <default-text-box width="200px" v-model:valueInput="formState.name" :disabled="true" :required="true" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
