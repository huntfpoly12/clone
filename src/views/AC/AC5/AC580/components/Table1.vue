<template>
  <a-spin :spinning="false" size="large">
    ...
    <DxDataGrid :show-row-lines="true" :hoverStateEnabled="true" :data-source="dataTable1" :show-borders="true"
      ...
      <DxColumn caption="결의번호" data-field="name" />
      <DxColumn caption="통장" data-field="bizNumber" />
      <DxColumn caption="일자" data-field="presidentName" />
      <DxColumn caption="결의 구분 "></DxColumn>
      <DxColumn caption="금액" data-field="presidentName2"></DxColumn>
      <DxColumn caption="통장적요 "></DxColumn>
      <DxColumn caption="적요 "></DxColumn>
      <DxColumn caption="계정과목 "></DxColumn>
      <DxColumn caption="상대계정 "></DxColumn>
      <DxColumn caption="자금원천 "></DxColumn>
      <DxColumn caption="후원금 등록여부" data-field="jobTypeCode" cell-template="jobTypeCode" />
      ...
      <DxSummary>
        <DxTotalItem column="결의번호" summary-type="count" display-format="사업소득자[소득구분]수: {0}" />
        <DxTotalItem class="custom-sumary" column="금액" summary-type="sum" display-format="지급액합계: {0}" />
