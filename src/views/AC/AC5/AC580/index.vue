  ...
  <div id="ac-580" class="p-20">
      ...
      <a-row>
        <a-col span="24">
          <div class="input-text">
            <radio-group
              :arrayValue="employeeFashionArr"
              v-model:valueRadioCheck="dataStateAC580.tableType"
            ...
            <span class="custom-waring">
              후원금의 경우 조정마감된 결의서 기준으로 후원금 수입/사용내역
              조회합니다
            </span>
          </div>
        </a-col>
        <a-col span="24">
          <div class="input-text">
            ...
            <radio-group
              :arrayValue="employeeFashionArr2"
              v-model:valueRadioCheck="dataStateAC580.employeeType2"
              layoutCustom="horizontal"
              class="mt-1"
            ></radio-group>
            <img
    ...
    <a-row class="bot-ctn mt-10" :gutter="[25]">
      <a-col :span="15" class="col1">
        <Table1
          v-if="dataStateAC580.tableType == 1 || dataStateAC580.tableType == 2"
        />
...
export default defineComponent({
  ...
  setup() {
    ...
    const {
      mutate: renewMajor,
      onDone: renewMajorDone,
      onError: renewMajorError,
    } = useMutation(mutations.renewMajorInsuranceConsignStatus);
