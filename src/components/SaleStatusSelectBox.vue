<template>
    <div>
        ...
        <a-modal v-if="confirmStatus" v-model:visible="visibleConfirm" :mask-closable="false" class="confirm-md"
            :width="521" @cancel="confirmClose(data)" :footer="null">
            <a-row>
                <a-col :span="4">
                ...
                <div class="confirm-input">
                    ...
                    <button-basic @onClick="confirmClose(data)" style="margin-left: 10px" mode="outlined" type="default"
                        text="취소" />
                    <button-basic @onClick="handleOkConfirm(data)" style="margin-left: 5px" mode="contained"
                        type="default" text="완료" :disabled="okButton" />
                </div>
            </a-row>
        </a-modal>
    </div>
