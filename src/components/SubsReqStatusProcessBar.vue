<template>
  <div style="display: flex">
    ...
    <div class="approval" :class="[ valueInput ==  SubscriptionRequestStatus.승인 ? 'active-approval' : '']" @click="setStatus(SubscriptionRequestStatus.승인)"></div>
    <div class="application-rejected" :class="[ valueInput ==  SubscriptionRequestStatus.반려 ? 'active-app-rejected' : '']" @click="setStatus(SubscriptionRequestStatus.반려)"></div>
